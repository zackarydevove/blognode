	...
	<div className='flex flex-col gap-3'>
		{
			post.comments.length > 0 && post.comments[0] ?
				<div className='flex flex-col gap-2'>
					<div>
						<p className='text-[#3f3e3f] hover:cursor-pointer hover:underline hover:text-[#646264]'>See more comments</p>
					</div>
					<div>
		...
		<div className='flex w-full gap-2'>
			...
			<div className='flex w-full rounded-2xl bg-[#2e2d2e] px-6 pt-3 '>
				<textarea className='flex-1 bg-[#2e2d2e] p-1 outline-none resize-none hide-scrollbar text-[#c4c4c4]'
